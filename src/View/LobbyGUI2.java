...
// * @author K
// */
//public class LobbyGUI2 extends javax.swing.JFrame {
//
//    /**
...
//    }
//    
//    public LobbyGUI2(String ip, DB_Controller db_cont, String nickname) {
//    	this.ip = ip;
...
//        });
//
//        i = Toolkit.getDefaultToolkit().getImage("rsc/images/lobby/user_btn.png");
//		icon = new ImageIcon(i);  //이미지 넣기
...
//        // TODO add your handling code here:
//    	MsgBoxGUI msgBox = new MsgBoxGUI(lobby, db_cont, nickname);
//    	msgBox.open();
//    }                                                
//
//    /**
...
//            java.util.logging.Logger.getLogger(LobbyGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
